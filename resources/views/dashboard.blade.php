                                ...
                                <tbody class="divide-y divide-gray-200">
                                    <tr>
                                        ...
                                        <td class="h-px w-72 whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800">Director</span>
                                                <span class="block text-sm text-gray-500">Human
                                                    resources</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="text-sm text-gray-500">28 Dec,
                                                    12:12</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    ...
                                                    <div class="grow">
                                                        <span
                                                            class="block text-sm font-semibold text-gray-800">David
                                                            Harrison</span>
                                                        <span
                                                            class="block text-sm text-gray-500">david@site.com</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="h-px w-72 whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800">Seller</span>
                                                <span class="block text-sm text-gray-500">Branding
                                                    products</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="text-sm text-gray-500">20 Dec,
                                                    09:27</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    ...
                                                    <div class="grow">
                                                        <span
                                                            class="block text-sm font-semibold text-gray-800">Anne
                                                            Richard</span>
                                                        <span
                                                            class="block text-sm text-gray-500">anne@site.com</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="h-px w-72 whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800">Designer</span>
                                                <span class="block text-sm text-gray-500">IT
                                                    department</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="text-sm text-gray-500">18 Dec,
                                                    15:20</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    ...
                                                    <div class="grow">
                                                        <span
                                                            class="block text-sm font-semibold text-gray-800">Samia
                                                            Kartoon</span>
                                                        <span
                                                            class="block text-sm text-gray-500">samia@site.com</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="h-px w-72 whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800">Executive
                                                    director</span>
                                                <span
                                                    class="block text-sm text-gray-500">Marketing</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="h-px w-72 whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800">Developer</span>
                                                <span class="block text-sm text-gray-500">Mobile
                                                    app</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="text-sm text-gray-500">15 Dec,
                                                    14:41</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    ...
                                                    <div class="grow">
                                                        <span
                                                            class="block text-sm font-semibold text-gray-800">Brian
                                                            Halligan</span>
                                                        <span
                                                            class="block text-sm text-gray-500">brian@site.com</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="h-px w-72 whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800">Accountant</span>
                                                <span
                                                    class="block text-sm text-gray-500">Finance</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="text-sm text-gray-500">11 Dec,
                                                    18:51</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    ...
                                                    <div class="grow">
                                                        <span
                                                            class="block text-sm font-semibold text-gray-800">Andy
                                                            Clerk</span>
                                                        <span
                                                            class="block text-sm text-gray-500">andy@site.com</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    ...
                                                    <div class="grow">
                                                        <span
                                                            class="block text-sm font-semibold text-gray-800">Bart
                                                            Simpson</span>
                                                        <span
                                                            class="block text-sm text-gray-500">Bart@site.com</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    ...
                                                    <div class="grow">
                                                        <span
                                                            class="block text-sm font-semibold text-gray-800">Camila
                                                            Welters</span>
                                                        <span
                                                            class="block text-sm text-gray-500">cwelt@site.com</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    ...
                                                    <div class="grow">
                                                        <span
                                                            class="block text-sm font-semibold text-gray-800">Oliver
                                                            Schevich</span>
                                                        <span
                                                            class="block text-sm text-gray-500">oliver@site.com</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    ...
                                                    <div class="grow">
                                                        <span
                                                            class="block text-sm font-semibold text-gray-800">Inna
                                                            Ivy</span>
                                                        <span
                                                            class="block text-sm text-gray-500">invy@site.com</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    ...
                                                    <div class="grow">
                                                        <span
                                                            class="block text-sm font-semibold text-gray-800">Jessica
                                                            Williams</span>
                                                        <span
